...
import sqlite3
import traceback
from .ui_elements import CharCreatorWorldviewSelectView, ProfileSaveView, ConversationControlView # 대화 제어 View 추가
...
"""
                ...
                try:
                    ...
                    await message.channel.send(bot_response, view=control_view)
